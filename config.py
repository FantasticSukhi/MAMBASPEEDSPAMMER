...
API_ID = 27251761
API_HASH = "22561f023ab0dccfe3b609845014ff0b"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6713994904").split()))
for x in OXYGEN:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5673931726"))
